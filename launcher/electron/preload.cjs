...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  openLogin: (input) => ipcRenderer.invoke("launcher:browser-login", input),
  addAccount: (input) => ipcRenderer.invoke("launcher:accounts-add", input),
  addWorkspace: (input) => ipcRenderer.invoke("launcher:accounts-add-workspace", input),
  renameAccount: (input) => ipcRenderer.invoke("launcher:accounts-rename-account", input),
  renameWorkspace: (input) => ipcRenderer.invoke("launcher:accounts-rename-workspace", input),
  setAccountCredentials: (input) => ipcRenderer.invoke("launcher:accounts-set-credentials", input),
  removeAccount: (slotId) => ipcRenderer.invoke("launcher:accounts-remove", slotId),
  removeAccountRecord: (input) => ipcRenderer.invoke("launcher:accounts-remove-account", input),
  captureIdentities: () => ipcRenderer.invoke("launcher:accounts-capture-identities"),
  validateAccounts: () => ipcRenderer.invoke("launcher:accounts-validate"),
  ...
  setupProvider: () => ipcRenderer.invoke("launcher:provider-setup"),
  copyProviderKey: () => ipcRenderer.invoke("launcher:provider-copy-key"),
  rotateProviderKey: () => ipcRenderer.invoke("launcher:provider-rotate-key"),
