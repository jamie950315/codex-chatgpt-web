...
const en = {
  ...
  settings: "Settings",
  accounts: "Accounts",
  accountsBody: "Add account, name it, enter its tunnel ID and API key, then log in. After that account is signed in, log in another workspace on the same ChatGPT login. You can rename or remove any account, including the last one. Email appears under the account name after sign-in; the ChatGPT workspace title appears under each workspace when ChatGPT shows it.",
  accountsEmpty: "Add and sign in to at least one ChatGPT account to use ChatGPT Web. The app will not keep a leftover account for you.",
  validateAccounts: "Validate",
  validatingAccounts: "Validating…",
  capturingIdentities: "Reading ChatGPT identities…",
  validationOk: "All accounts, tunnels, and connectors passed",
  validationFailed: "Some accounts or workspaces need attention",
  addAccount: "Add account",
  accountName: "Account name",
  workspaceName: "Workspace name",
  addWorkspace: "Log in another workspace",
  addWorkspaceHint: "Sign in with this same ChatGPT account, switch to the workspace you want, then wait until the sign-in window closes.",
  signInSlot: "Log in",
  removeSlot: "Remove",
  primarySlot: "Primary",
  creatingAccount: "Log in",
  loginAccount: "Log in",
  cancel: "Cancel",
  ...
  providerApi: "Independent Provider API",
  providerApiBody: "Use this local endpoint as a Cockpit Tools Model Provider without changing the Codex route. The API key is copied directly to the system clipboard and is never shown here.",
  providerEnabled: "Provider API enabled",
  providerDisabled: "Provider API not configured",
  enableProvider: "Enable Provider API",
  copyApiKey: "Copy API key",
  rotateApiKey: "Rotate and copy key",
...
const zh: Record<keyof typeof en, string> = {
  ...
  settings: "设置项",
  accounts: "账号",
  accountsBody: "先点添加账号，填写名称、Tunnel ID 和 API key，然后登录。该账号登录成功后，再为同一个 ChatGPT 登录其他 workspace。任何账号都可以删除，包括最后一个。账号名称下方会显示 email；workspace 名称下方会尽量显示 chatgpt.com 上的 workspace 名称。",
  accountsEmpty: "请至少添加并登录一个 ChatGPT 账号才能使用 ChatGPT Web。应用不会替你保留一个删不掉的账号。",
  validateAccounts: "验证",
  validatingAccounts: "正在验证…",
  capturingIdentities: "正在读取 ChatGPT 身份…",
  validationOk: "所有账号、tunnel 和 connector 均正常",
  validationFailed: "有账号或 workspace 需要处理",
  addAccount: "添加账号",
  accountName: "账号名称",
  workspaceName: "Workspace 名称",
  addWorkspace: "登录另一个 workspace",
  addWorkspaceHint: "请用同一个 ChatGPT 账号登录，切到要使用的 workspace，然后等此窗口关闭。",
  signInSlot: "登录",
  removeSlot: "移除",
  primarySlot: "主账号",
  creatingAccount: "登录",
  ...
  settingsTitle: "启动器设置",
  providerApi: "独立 Provider API",
  providerApiBody: "将此本地端点用作 Cockpit Tools Model Provider，不更改 Codex 路由。API key 只会直接复制到系统剪贴板，不会显示在这里。",
  providerEnabled: "Provider API 已启用",
  providerDisabled: "Provider API 未配置",
  enableProvider: "启用 Provider API",
  copyApiKey: "复制 API key",
  rotateApiKey: "轮换并复制 key",
  providerRuntime: "运行状态",
  general: "通用",
  launchAtLogin: "登录时启动",
