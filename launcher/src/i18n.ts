...
const en = {
  ...
  biggerContextBody: "Experimental: Instant, Medium, High, Extra High and Pro send large original context as a TXT attachment. Small requests stay inline. Each new file-based turn uploads the complete context again to keep tools available. Files, instructions and images count toward each mode's existing limit; Instant does not gain a 400k window. Failures are reported without silently trimming context or switching models. Restart Codex after changing this setting. Uploads may increase waiting time or cooldowns. Disabled by default.",
  biggerContextRecommendationTitle: "Use a larger ChatGPT Web context",
  biggerContextRecommendationBody: "Bigger Context uses a full-context TXT attachment for large automatic requests while preserving each mode's own limits. It remains experimental and may increase waiting time or cooldowns.",
  biggerContextRecommendationToggleBody: "Automatically upload large context as TXT without changing the selected model.",
  chatgptPlan: "ChatGPT plan",
  chatgptPlanBody: "Plus: Instant 123k, others 270k. Pro: Instant 123k, others 400k. Restart Codex after changing this.",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
  webSubagents: "Allow ChatGPT Web sub-agents",
  webSubagentsBody: "When off, ChatGPT Web models cannot spawn Codex sub-agents. Official models are unchanged. Restart Codex after changing this.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  biggerContextBody: "实验性：Instant、Medium、High、Extra High 和 Pro 的大型原始上下文会作为 TXT 附件发送，小请求仍直接发送。每个新的文件回合会重新上传完整上下文，确保工具可用。文件、指令和图片计入各模式原有限制，Instant 不会因此获得 400k 容量。失败会报错，不会静默删减内容或切换模型。更改后请重启 Codex。上传可能增加等待或冷却时间。默认关闭。",
  biggerContextRecommendationTitle: "使用更大的 ChatGPT Web 上下文",
  biggerContextRecommendationBody: "Bigger Context 会将自动模式的大型原始上下文作为 TXT 附件发送，并保留各模式的容量限制。仍属实验性，可能增加等待或冷却时间。",
  biggerContextRecommendationToggleBody: "自动上传大型上下文为 TXT，不改变所选模型。",
  chatgptPlan: "ChatGPT 会员等级",
  chatgptPlanBody: "Plus：Instant 123k，其余 270k。Pro：Instant 123k，其余 400k。更改后请重启 Codex。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
  webSubagents: "允许 ChatGPT Web 使用子代理",
  webSubagentsBody: "关闭时，ChatGPT Web 模型不能生成 Codex 子代理。官方模型不受影响。更改后请重启 Codex。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  biggerContextBody: "試験的機能：Instant、Medium、High、Extra High、Pro の大きな元コンテキストを TXT 添付で送信します。小さなリクエストは直接送信します。ツールを維持するため、新しいファイル送信ターンでは全コンテキストを再送します。ファイル、指示、画像は各モードの既存上限に計上し、Instant が 400k になるわけではありません。失敗時に内容を黙って削除したりモデルを変更したりしません。変更後は Codex を再起動してください。待機時間やクールダウンが増える場合があります。初期設定では無効です。",
  biggerContextRecommendationTitle: "より大きな ChatGPT Web コンテキストを使用",
  biggerContextRecommendationBody: "Bigger Context は自動モードの大きな元コンテキストを TXT 添付で送信し、各モードの上限を維持します。試験的機能のため、待機時間やクールダウンが増える場合があります。",
  biggerContextRecommendationToggleBody: "選択したモデルを変えずに、大きなコンテキストを TXT として自動送信します。",
  chatgptPlan: "ChatGPT プラン",
  chatgptPlanBody: "Plus：Instant 123k、その他 270k。Pro：Instant 123k、その他 400k。変更後は Codex を再起動してください。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
  webSubagents: "ChatGPT Web のサブエージェントを許可",
  webSubagentsBody: "オフのとき、ChatGPT Web モデルは Codex サブエージェントを生成できません。公式モデルは変わりません。変更後は Codex を再起動してください。",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  biggerContextBody: "實驗性：Instant、Medium、High、Extra High 和 Pro 的大型原始上下文會作為 TXT 附件傳送，小請求仍直接傳送。每個新的檔案回合會重新上傳完整上下文，確保工具可用。檔案、指令和圖片計入各模式原有限制，Instant 不會因此獲得 400k 容量。失敗會報錯，不會悄悄刪減內容或切換模型。變更後請重新啟動 Codex。上傳可能增加等待或冷卻時間。預設關閉。",
  biggerContextRecommendationTitle: "使用更大的 ChatGPT Web 上下文",
  biggerContextRecommendationBody: "Bigger Context 會將自動模式的大型原始上下文作為 TXT 附件傳送，並保留各模式的容量限制。仍屬實驗性，可能增加等待或冷卻時間。",
  biggerContextRecommendationToggleBody: "自動上傳大型上下文為 TXT，不改變所選模型。",
  chatgptPlan: "ChatGPT 會員等級",
  chatgptPlanBody: "Plus：Instant 123k，其餘 270k。Pro：Instant 123k，其餘 400k。變更後請重新啟動 Codex。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
  webSubagents: "允許 ChatGPT Web 使用子代理",
  webSubagentsBody: "關閉時，ChatGPT Web 模型不能產生 Codex 子代理。官方模型不受影響。變更後請重新啟動 Codex。",
